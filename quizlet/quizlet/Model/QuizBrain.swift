...
struct QuizBrain {
    let quiz = [
        ...
        Question(q: "Most car accidents happen on a Tuesday.", a: "True"),
        Question(q: "The largest organs in the human body are the lungs", a: "False"),
...
var questionNumber = 0
    ...
    func getQuestionText() -> String {
        return quiz[questionNumber].question //return question text that corresponds to question number
    }
