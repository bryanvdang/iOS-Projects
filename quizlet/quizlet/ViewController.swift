...
class ViewController: UIViewController {
    ...
    @IBAction func answerButtonPressed(_ sender: UIButton) {
        ...
        let actualAnswer = quiz[questionNumber].answer //look at the quiz array, call the answer property within the Question object that correlates with the matching question number
    ...
    func updateUI() {
        ...
        questionLabel.text = quiz[questionNumber].question //???? why is this not given an index of 0? How does it know to look a the first question object?
    }
}
